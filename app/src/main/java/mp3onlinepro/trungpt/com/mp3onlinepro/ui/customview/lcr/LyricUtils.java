package mp3onlinepro.trungpt.com.mp3onlinepro.ui.customview.lcr;
...
public class LyricUtils {
     ...
     */
    public static Lyric.Sentence getSentence(Lyric lyric, long ts) {
     ...
     */
    public static Lyric.Sentence getSentence(Lyric lyric, long ts, int index) {
     ...
     */
    public static Lyric.Sentence getSentence(Lyric lyric, long ts, int index, int offset) {
